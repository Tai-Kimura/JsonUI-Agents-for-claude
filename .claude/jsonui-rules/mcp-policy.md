...
| `navigation-ios` / `navigation-android` / `navigation-web` | `get_project_config`, `list_screen_specs`, `read_spec_file`, `read_layout_file`, `get_platform_mapping`, `get_screen_identity` |

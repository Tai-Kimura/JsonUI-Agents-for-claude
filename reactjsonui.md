...
|-----------|---------------|-----------------|
| JSON layout | `src/Layouts/*.json` | `jsonui-layout` |
| Data section | `src/Layouts/*.json` (data section) | `jsonui-data` |
| Hooks | `src/hooks/*.ts` | `jsonui-viewmodel` |
| Styles | `src/Styles/*.json` | `jsonui-refactor` |

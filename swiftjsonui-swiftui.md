...
3. Run `build` to generate code
4. Define data section and run `build` again
5. Implement ViewModel business logic
6. **Test and verify the screen works**
...
|-----------|-------------------|-------------------|
| JSON layout | `jsonui-layout.md` | `Layouts/*.json` |
| Layout refactoring | `jsonui-refactor.md` | `Layouts/*.json`, `Styles/*.json` |
| Data section | `jsonui-data.md` | `Layouts/*.json` |
| ViewModel | `jsonui-viewmodel.md` | `ViewModel/*.swift` |

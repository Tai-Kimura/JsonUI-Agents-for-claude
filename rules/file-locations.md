...
- **NEVER** reorganize generated files into subdirectories like `cells/`, `popups/`, `includes/`
...
mv Layouts/ItemCell.json Layouts/cells/ItemCell.json  # FORBIDDEN

# ✅ CORRECT - Specify path in CLI argument
./sjui_tools/bin/sjui g collection Home/cells/ItemCell
```
